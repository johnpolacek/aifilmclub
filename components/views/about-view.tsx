        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground text-center mb-12 leading-relaxed">
              AI Film Camp exists to democratize filmmaking and foster a vibrant community where
              creators can learn, share, and push the boundaries of what&apos;s possible with
              AI-powered tools. We believe that everyone has a story to tell, and AI can help bring
            ...
            <div className="space-y-8">
              <div className="bg-background/60 backdrop-blur-sm border border-border/40 rounded-lg p-6 lg:p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Share your work-in-progress and completed projects with a supportive community.
                  Get constructive feedback, discover new techniques, and find inspiration from
                  fellow creators.
                </p>
              </div>
              ...
              <div className="bg-background/60 backdrop-blur-sm border border-border/40 rounded-lg p-6 lg:p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Access curated tutorials, guides, and resources to master AI filmmaking tools.
                  From beginners to advanced creators, we have content to help you level up your
                  skills.
                </p>
              </div>
              ...
              <div className="bg-background/60 backdrop-blur-sm border border-border/40 rounded-lg p-6 lg:p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Connect with other filmmakers, form teams, and collaborate on projects. Share
                  insights, exchange ideas, and build lasting relationships within the AI filmmaking
                  community.
                </p>
              </div>
            </div>
